...
class RockPaperScissorsGame:
    ...
    def create_widgets(self):
        ...
        self.rock_button = tk.Button(self.root, text="Rock", command=lambda: self.play('rock'), font=('Arial', 14))
        self.rock_button.grid(row=0, column=0, padx=10, pady=10)

        self.paper_button = tk.Button(self.root, text="Paper", command=lambda: self.play('paper'), font=('Arial', 14))
        self.paper_button.grid(row=0, column=1, padx=10, pady=10)

        self.scissors_button = tk.Button(self.root, text="Scissors", command=lambda: self.play('scissors'), font=('Arial', 14))
